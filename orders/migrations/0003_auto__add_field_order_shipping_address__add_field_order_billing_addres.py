...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'orders.order': {
            ...
            'billing_address': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'billing_address'", 'to': u"orm['accounts.UserAddress']"}),
            ...
            'shipping_address': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shipping_address'", 'to': u"orm['accounts.UserAddress']"}),
